...
```
open .claude/skills/sketch-findings-ace-online/sources/001-phase-29-mp-qr-suite/index.html
```
</findings_index>
...
- CLAUDE.md (project root) — Sequelize underscored, ESLint warning=error, apiConnector.remove(), postgres pool 변경 금지
