...
Use template from `/Users/marcoskim/Trabajos_Programming/ACE_online_1.0/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/marcoskim/Trabajos_Programming/ACE_online_1.0/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/marcoskim/Trabajos_Programming/ACE_online_1.0/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
