...
| api | `e6a80417` | 매뉴얼: fichaje QR = `Alt+V` | ⬜ **push 대기** |
| app | `e5e429d6` | `Ctrl+V` → **`Alt+V`** (붙여넣기 복구) | ⬜ **push 대기** |
...
| app | tsc 0 · eslint 0 · jest **84 suites / 982건** |
| 돌연변이 | **19개 전부 죽었다** (그중 1건은 적용 실패를 잡아내 재실행) |
